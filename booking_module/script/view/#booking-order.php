...
<table border="1" cellpadding="5" width="800">
	<tr>
		...
		<form action="booked.php" method="post">
			<h3>Make booking</h3>
			<p><input checked="checked" name="item" type="hidden" value="BookingOrder" />
    ...
    <tr>
     ...
     <?php 
      ...
      while ($myData = mysqli_fetch_array($myQry)) {
        if ( $datateam == $myData['kd_team']) {
          $cek = " selected";
        } else { $cek='';}
        echo "<option value='$myData[kd_team]' $cek>$myData[kd_team] $myData[nm_team] </option> ";
      }
      ?>
    </select>
     </td>
    ...
    <tr>
     ...
     <?php 
      ...
      while ($myData = mysqli_fetch_array($myQry)) {
        ...
        echo "<option value='$myData[kd_team]' $cek>$myData[nm_team] $myData[nm_leader]</option> ";
      }
      ?>
    </select>
     </td>
